                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" type="text" id="editpatientName" placeholder="Enter Patient's Name" name="editpatientName">
                                    <label for="editpatientName">Patient Name</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" type="number" id="editage" placeholder="Enter Age" name="editage">
                                    <label for="editage">Age</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <select name="editgender" class="form-select" id="edit_floatingSelect">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" type="tel" id="editcontactnumber" name="editcontactnumber" placeholder="Enter Contact Number">
                                    <label for="editcontactnumber">Contact Number</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" type="text" id="editaddress" name="editaddress" placeholder="Enter Address">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                viewButtons.forEach(button => {
                    button.addEventListener('click', function () {
                        ...
                        fetch(`/staff/patients/${PatientId}`)
                            .then(response => {
                                if (!response.ok) {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    editForm.action = `/staff/patients/update/${PatientID}`;

                    console.log(editForm.action);

                    fetch(`/staff/patients/edit/${PatientID}`)
