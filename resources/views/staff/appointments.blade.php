...
<div class="page-wrapper">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body text-center" style="padding:30px;">
                    ...
                    <div class="col-md-12">
                        <!-- <input type="hidden" id="appointment-status"> -->
                        <div class="form-floating mb-3">
                            <input
                                type="text"
                                id="AppointmentNote"
                    ...
                    <div class="mt-4 d-flex justify-content-end gap-2">
                        <button class="btn btn-sm btn-submit w-100 me-2" id="confirm-action">Confirm</button>
    ...
    @section('scripts')
        ...
        <script src="{{ asset("assets/js/staff/appointment/appointment-delete.js")}}"></script>
