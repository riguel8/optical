...
<div class="modal fade" id="editModal">
    ...
    @section('scripts')
        ...
        <script src="{{ asset('assets/js/staff/chatbot/create.js') }}"></script>
        <script src="{{ asset('assets/js/staff/chatbot/update.js') }}"></script>
        <script src="{{ asset('assets/js/staff/chatbot/delete.js') }}"></script>
